...
topic_model.save("./contrarian_topic_model", serialization="safetensors", save_ctfidf=True, save_embedding_model="dunzhang/stella_en_400M_v5")
...
hierarchy_fig.write_html("contrarian_topic_hierarchy_with_combined_labels.html")
doc_hierarchy_fig.write_html("contrarian_doc_topic_hierarchy.html")